...
namespace V_LiteDbHelper
{
    public class LiteDbHelper
    {
        ...
        private LiteDbHelper(string ConnectionString)
        {
            this.ConnectionString = ConnectionString;
        }

        public static LiteDbHelper GetInstance(string ConnectionString)
        {
            if (!IsInstanceCreated) return new LiteDbHelper(ConnectionString);
